...
public class MessageInSendingQueue extends MessageInfo{
	...
	public MessageInSendingQueue(String aMessage, MessageInfo aSuperClassInfo) {
		super(aMessage, aSuperClassInfo);
	}
	
	public static MessageInSendingQueue toTraceable(String aMessage) {
		return new MessageInSendingQueue(aMessage, MessageInfo.toTraceable(aMessage));
	}
