...
public class CodeParserProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations,
        ...
        CodeParserTreeVisitor visitor = new CodeParserTreeVisitor();
        ...
        for (Element e : roundEnvironment.getRootElements()) {
            ...
            SourceClass clazzInfo = visitor.getClassInfo();
            LocationLinesSetter.setLocationInfoForElements(clazzInfo);
            SourceClassManager.getInstance().addClassInfo(className, clazzInfo);
