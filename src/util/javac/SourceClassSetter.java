...
public class SourceClassSetter {
     ...
     * @param trees trees
     */
    public static void populateClassInfo(SourceClass clazzInfo,
        ...
        for (Modifier modifier : e.getModifiers()) {
            DataSetterUtil.setModifiers(modifier.toString(), (JavaClassInfo) clazzInfo);
        }
        ...
        Location locationInfo = DataSetterUtil.getLocationInfo(trees, path, classTree);
        clazzInfo.setLocationInfo(locationInfo);
        DataSetterUtil.setSourceCodeInfo(clazzInfo.getCodeInfo(), classTree, locationInfo);
