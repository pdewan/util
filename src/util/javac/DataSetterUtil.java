...
//    public static void setModifiers(String modifiers, BaseJavaClassModelInfo elementInfo) {
    ...
    public static Location getLocationInfo(Trees trees, TreePath path, Tree tree) {
        ...
        locationInfo.setEndOffset((int) sourcePosition.getEndPosition(path.getCompilationUnit(), tree)); 
        return locationInfo;
    }
    public static void setSourceCodeInfo(CodeInfo aCodeInfo,  Tree tree, Location aLocation) {

//    public static void setSourceCodeInfo(CodeInfo aCodeInfo, Trees trees, TreePath path, Tree tree) {
//    	Location aLocation = getLocationInfo(trees, path, tree);
    	aCodeInfo.setStartPosition(aLocation.getStartOffset());
    	aCodeInfo.setEndPosition(aLocation.getEndOffset());
    	String sourceText = tree.toString();
    	String[] lines = sourceText.split("\r\n");
    	aCodeInfo.setSourceCodeLines(lines);
    }
}
