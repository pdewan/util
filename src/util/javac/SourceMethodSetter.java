...
public class SourceMethodSetter {
     ...
     * @param trees trees
     */
    public static void populateMethodInfo(SourceClass clazzInfo,
            MethodTree methodTree, TreePath path, Trees trees) {

        SourceMethod methodInfo = new ASourceMethod();
        ...
        for (Modifier modifier : e.getModifiers()) {
            DataSetterUtil.setModifiers(modifier.toString(), (BaseJavaClassModelInfo) methodInfo);
        }
       ...
       Location locationInfo = DataSetterUtil.getLocationInfo(trees, path, methodTree);
        methodInfo.setLocationInfo(locationInfo);    
         DataSetterUtil.setSourceCodeInfo(methodInfo.getCodeInfo(),  methodTree, locationInfo);
    ...
    private static void visitExecutable(Element e, 
        ...
        e.accept(new SimpleElementVisitor6<Object, MethodInfo>() {
            ...
            public Object visitExecutable(ExecutableElement element, 
                ...
                return super.visitExecutable(element, (MethodInfo) methodInfo);
            }
        }, null);
    }
}
